...
This page walks you from a clean checkout to a rendered figure, then points you at the worked example notebooks that live under [`notebooks/`](https://github.com/SotoLF/Prot2Exon/tree/main/notebooks) in the repo. Start with the quickstart, then dive into whichever notebook matches your use case.
...
Notebook: [`pfam_proteome_atlas.ipynb`](https://github.com/SotoLF/Prot2Exon/blob/main/notebooks/pfam_proteome_atlas.ipynb)
...
Notebook: [`clinvar_pathogenic.ipynb`](https://github.com/SotoLF/Prot2Exon/blob/main/notebooks/clinvar_pathogenic.ipynb)
