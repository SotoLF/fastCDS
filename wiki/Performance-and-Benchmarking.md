...
- **TransVar (Ensembl 95):** **4,992 / 4,992 = 100.00% exact** on every stratum, including the 200 incomplete-CDS queries. (The naive *cross-release* comparison scores only ~35%, but that is pure drift — ~3,200 query transcripts post-date release 95 and are absent from TransVar's DB; on matched v95 it disappears.)
