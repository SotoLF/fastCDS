...
Reproduce the grid with [`reproduce_paper/benchmarks/threads_batch_grid.py`](https://github.com/SotoLF/fastCDS/blob/main/reproduce_paper/benchmarks/threads_batch_grid.py).
