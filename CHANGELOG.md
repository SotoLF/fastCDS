...
- `fastCDS map --bed12` — emit `domain_blocks.bed12` alongside any `--output` mode (no-op under `--output all`/`bed12`), so you can get the IGV-ready BED12 without switching to `--output bed12`.
